...
export function SubmitClaimForm({
  ...
  // Same manualId ?? defaultId derivation as TopBar/ActPanel (see TopBar's
  // comment) — avoids seeding useState with a value that isn't known until
  // localStorage resolves on the client.
